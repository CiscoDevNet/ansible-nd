...
class ExternalConnectivityManagementModel(NDNestedModel):
    ...
    allow_same_loopback_ip_on_switches: bool = Field(
        ...
        description="Allow same loopback IP on switches",
        default=False
    )
    ...
    day0_plug_and_play: bool = Field(alias="day0PlugAndPlay", description="Enable day-0 plug and play", default=False)
    ...
    dhcp_protocol_version: DhcpProtocolVersionEnum = Field(
        ...
        description="DHCP protocol version",
    ...
    # Domain
    domain_name: str = Field(alias="domainName", description="Domain name", default="")

    # DPU Pinning
    enable_dpu_pinning: bool = Field(alias="enableDpuPinning", description="Enable DPU pinning", default=False)

    # Extra Config
    extra_config_aaa: str = Field(alias="extraConfigAaa", description="Extra AAA config", default="")
    extra_config_fabric: str = Field(alias="extraConfigFabric", description="Extra fabric config", default="")
    extra_config_nxos_bootstrap: str = Field(alias="extraConfigNxosBootstrap", description="Extra NX-OS bootstrap config", default="")
    extra_config_xe_bootstrap: str = Field(alias="extraConfigXeBootstrap", description="Extra XE bootstrap config", default="")

    # Inband Management
    inband_day0_bootstrap: bool = Field(alias="inbandDay0Bootstrap", description="Enable inband day-0 bootstrap", default=False)
    ...
    interface_statistics_load_interval: int = Field(
        ...
        description="Interface statistics load interval",
        default=10
    )
    ...
    # Monitored Mode
    monitored_mode: bool = Field(alias="monitoredMode", description="Enable monitored mode", default=False)
    ...
    sub_interface_dot1q_range: str = Field(
        ...
        description="Sub-interface 802.1q range",
        default="2-511"
    )
