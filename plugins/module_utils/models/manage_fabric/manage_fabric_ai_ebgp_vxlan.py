...
AI eBGP VXLAN fabrics through the Nexus Dashboard Fabric Controller (NDFC) API.
...
class AimlVxlanEbgpManagementModel(VxlanEbgpManagementModel):
    ...
    type: Literal[FabricTypeEnum.AIML_VXLAN_EBGP] = Field(
        description="Type of the fabric", default=FabricTypeEnum.AIML_VXLAN_EBGP
    )
