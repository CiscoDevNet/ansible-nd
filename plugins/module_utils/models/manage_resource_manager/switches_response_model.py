...
class SwitchAdditionalDataMeta(NDNestedModel):
    ...
    switch_db_id: int | None = Field(
        default=None,
        alias="switchDbId",
        description="Internal database ID of the switch",
    )
    switch_uuid: str | None = Field(
        default=None,
        alias="switchUuid",
...
class SwitchAdditionalData(NDNestedModel):
    ...
    config_sync_status: str | None = Field(
        default=None,
        alias="configSyncStatus",
        description="Configuration synchronisation status",
    )
    discovered_system_mode: str | None = Field(
        default=None,
...
class SwitchRecord(NDNestedModel):
    ...
    additional_data: SwitchAdditionalData | None = Field(
        default=None,
        alias="additionalData",
        description="Extended switch metadata",
    )
    advisory_level: str | None = Field(
        default=None,
        alias="advisoryLevel",
        description="Advisory level for the switch",
    )
    alert_suspend: str | None = Field(
        default=None,
        alias="alertSuspend",
        description="Alert suspend status",
    )
    anomaly_level: str | None = Field(
        default=None,
        alias="anomalyLevel",
...
class SwitchesMeta(NDNestedModel):
    ...
    counts: SwitchesMetaCounts | None = Field(
        default=None,
