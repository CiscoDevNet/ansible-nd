...
class ExtendedCommunityListModel(NDBaseModel):
    ...
    def normalize_gathered_filter(cls, filter_item: dict) -> dict:
        ...
        validated = ExtendedCommunityListGatheredFilterModel.model_validate(
            filter_item,
            by_name=True,
