...
from ansible_collections.cisco.nd.plugins.module_utils.utils import issubset, NO_LOG_PLACEHOLDER
...
class NDBaseModel(BaseModel, ABC):
    ...
    def to_config(self, **kwargs) -> Dict[str, Any]:
        ...
        (after/before/proposed/gathered): the key stays visible so callers see
