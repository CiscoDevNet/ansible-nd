...
class VrfFabricResolver:
    ...
    def _fetch_federated_fabric_associations(self, fabric_details: dict[str, Any] | None = None) -> Any:
        ...
        MCFG resource surface as a bounded probe:
            GET /api/v1/oneManage/manage/fabrics/{fabricName}/vrfs?max=1
        ...
        endpoint = EpOneManageFabricsVrfsGet(fabric_name=self.fabric_name)
    ...
    def _request_onemanage_probe(self, path: str, method: str) -> Any:
        ...
        Fabric detection treats OneManage as the MCFG fallback only.  MSD and
        standalone fabrics should not fail simply because the OneManage resource
        surface is unavailable to the current session.
        """
