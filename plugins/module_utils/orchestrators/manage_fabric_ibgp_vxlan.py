...
class ManageIbgpFabricOrchestrator(ConfigActionsMixin, NDBaseOrchestrator):
    ...
    _FABRIC_TYPE_FILTER: ClassVar[str] = "vxlanIbgp"
    ...
    def _query_all_for_management_states(self) -> ResponseType:
        """Fetch all fabrics and filter to vxlanIbgp client-side."""
    ...
    def _query_all_for_gathered(self, gathered_filters) -> ResponseType:
        """Use server-side Lucene to narrow fabric results before client-side type checking."""
        all_fabrics = []
