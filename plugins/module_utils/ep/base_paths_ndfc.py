...
"""
Centralized base paths for legacy NDFC API endpoints.
...
class BasePath:
    ...
    Centralized API Base Paths for legacy NDFC

    ## Description

    Provides centralized base path definitions for all NDFC API endpoints.
