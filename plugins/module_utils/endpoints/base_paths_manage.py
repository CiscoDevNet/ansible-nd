...
from ansible_collections.cisco.nd.plugins.module_utils.endpoints.base_path import ND_MANAGE_API
...
class BasePath:
    ...
    def nd_manage_fabrics(cls, *segments: str) -> str:
        ...
        ```python
        path = BasePath.nd_manage_fabrics()
        # Returns: /api/v1/manage/fabrics
        ```
        """
