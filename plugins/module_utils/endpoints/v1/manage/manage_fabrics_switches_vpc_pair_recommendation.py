...
class EpVpcPairRecommendationGet(
    ...
    class_name: Literal["EpVpcPairRecommendationGet"] = Field(default="EpVpcPairRecommendationGet")
    ...
    def path(self) -> str:
        ...
        return BasePath.path(
            "fabrics", self.fabric_name, "switches", self.switch_id, "vpcPairRecommendation"
        )
...
__all__ = ["EpVpcPairRecommendationGet"]
