...
description:
- Manage import configuration type compliance requirements on Cisco Nexus Dashboard Insights (NDI).
author:
- Akini Ross (@akinross)
options:
  file:
    description:
    - The name of the import configuration file to upload.
    type: str
...
EXAMPLES = r"""
- name: Get all import configuration type compliance requirements
