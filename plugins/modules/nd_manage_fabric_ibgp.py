...
from ansible_collections.cisco.nd.plugins.module_utils.orchestrators.manage_fabric import ManageFabricOrchestrator


def main():
    argument_spec = nd_argument_spec()
    argument_spec.update(FabricModel.get_argument_spec())
    ...
    try:
        ...
        nd_state_machine = NDStateMachine(
            module=module,
            model_orchestrator=ManageFabricOrchestrator,
        )
