...
def _orchestrator() -> ManageFabricGroupVxlanOrchestrator:
    return ManageFabricGroupVxlanOrchestrator(rest_send=RestSend({"check_mode": False, "state": "merged"}))
...
def test_manage_fabric_group_vxlan_endpoints_00100(monkeypatch):
...
def test_manage_fabric_group_vxlan_endpoints_00110(monkeypatch):
...
def test_manage_fabric_group_vxlan_endpoints_00120(monkeypatch):
...
def test_manage_fabric_group_vxlan_endpoints_00130(monkeypatch):
...
def test_manage_fabric_group_vxlan_endpoints_00140(monkeypatch):
...
def test_manage_fabric_group_vxlan_endpoints_00150(monkeypatch):
...
def test_manage_fabric_group_vxlan_endpoints_00160(monkeypatch):
...
def test_manage_fabric_group_vxlan_endpoints_00170(monkeypatch):
